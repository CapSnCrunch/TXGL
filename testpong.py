...
if __name__ == '__main__':
    ...
    A = np.array([[2.66523767, 3.1347917], 
                  [2.58863452, 3.41989388]])
    B = np.array([[3.27417278, 1.97883931],
    ...
    for pair in itertools.combinations(intervals, 2):
        if pair[0].a > pair[0].b:
            if pair[1].a > pair[1].b:
        elif non_triv_intersect(pair[0].a, pair[0].b, pair[1].a, pair[1].b):
